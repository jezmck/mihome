...
function apiRequest(endpoint, params, focus, callback) {
	...
	console.log(`Endpoint: ${endpoint}, Params: ${JSON.stringify(params)}, Focus: ${focus}`);
	request({
		url: URL,
		headers: {
			'User-Agent': user_agent,
...
module.exports = {
	...
	apiRequest: (endpoint, params, focus, callback) => apiRequest(endpoint, params, focus, callback), // legacy method for quick scripting.
};
